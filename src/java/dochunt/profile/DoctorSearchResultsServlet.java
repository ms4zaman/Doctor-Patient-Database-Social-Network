...
public class DoctorSearchResultsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String reviewedByFriend = request.getParameter("reviewedByFriend");
        String comment = request.getParameter("comment");
        
        try {
            ArrayList<Patient> patients = searchDoctors(firstName, lastName, specializationName, city, provId, reviewedByFriend, comment);
